...
Որպես դաս սահմանված տեսակը հղման տեսակ է։ Գործարկման ժամանակ, երբ դուք հայտարարում եք հղման տիպի փոփոխական, փոփոխականը պարունակում է null արժեքը մինչև դուք բացահայտորեն չստեղծեք դասի օրինակ՝ օգտագործելով new օպերատորը, կամ չվերագրեք դրան արդեն ստեղծված համատեղելի տիպի օբյեկտ։
...
Չնայած դրանք երբեմն օգտագործվում են փոխարինելիորեն, դասը և օբյեկտը տարբեր բաներ են: Դասը սահմանում է օբյեկտի տեսակ, բայց այն ինքնին օբյեկտ չէ: Օբյեկտը դասի վրա հիմնված կոնկրետ օրինակ է:
...
Օրինակի երկրորդ և երրորդ տողերում ստեղծում է երկու օբյեկտի հղումներ, որոնք երկուսն էլ վերաբերում են նույն օբյեկտին։ Հետևաբար, object3-ի միջոցով օբյեկտում կատարված ցանկացած փոփոխություն արտացոլվում է object4-ում։ 
...
Սովորաբար դաշտերը հայտարարվում են [**private** կամ **protected**](#հասանելիության-մոդիֆիկատորներ-access-modifiers) հասանելիությամբ: Դաշտերին այս անուղղակի դիմելու դեպքում դուք կարող եք պաշտպանվել սխալ մուտքային արժեքներից:

Դաշտերում սովորաբար պահում են այն տվյալները, որոնք պետք է հասանելի լինեն դասի մեկից ավելի մեթոդների համար և պետք է պահվեն ցանկացած մեթոդի կյանքի տևողությունից ավելի երկար։

Փոփոխականները, որոնք չեն օգտագործվում մեկ մեթոդի շրջանակից դուրս, պետք է հայտարարվեն, որպես տեղային փոփոխականներ մեթոդի մարմնում։
 ...
 **Set** accessor չունեցող հատկությունը համարվում է միայն ընթերցման համար: **Get** accessor չունեցող հատկությունը համարվում է միայն գրելու համար:
 ...
 Երկու accessor-ներ ունեցող հատկությունը հնարավոր է կարդալ և փոփոխել: Դուք կարող եք օգտագործել **init** accessor-ը **set** accessor-ի փոխարեն, որպեսզի հատկությանը արժեք սահմանելը լինի որպես օբյեկտի ինիցիալիզացիայի մաս, հետագայում ​​դարձնելով նրան միայն ընթերցման համար:
...
public class Date
{
    ...
    public int Month
    {
        get => _month; // հատկությունը կարդալիս կվերադարձվի _month դաշտի արժեքը։
        set
        {
