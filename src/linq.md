...
Հարցումը արտահայտություն է, որի միջոցով տվյալներ են ստանում տվյալների աղբյուրից: Տարբեր տվյալների աղբյուրներ ունեն տարբեր հարցման լեզուներ, օրինակ՝ SQL-ը՝ ռելացիոն տվյալների բազաների համար և XQuery-ն՝ XML-ի համար:
...
Հարցման կատարման արդյունքում ստեղծում է բոլոր այն ուսանողների ցանկը, որոնց միավորները առաջին թեստում 90-ից մեծ էին։ Քանի որ ընտրված է ամբողջ Student օբյեկտը, հարցման տեսակը IEnumerable<Student> է։ Չնայած կոդը կարող է նաև օգտագործել անուղղակի տիպավորում՝ օգտագործելով var բանալի բառը, ակնհայտ տիպավորումն օգտագործվում է արդյունքները հստակ պատկերելու համար։
