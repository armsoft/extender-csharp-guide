...
int[] source = [0, 1, 2, 3, 4, 5]; // source փոփոխականը հանդիսանում է int արժեքներ պարունակող զանգված (array)
