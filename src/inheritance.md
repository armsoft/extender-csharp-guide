...
Ածանցյալ դաս ստեղծելիս, այն անուղղակիորեն ստանում է բազային դասի բոլոր անդամները, բացառությամբ դրա կոնստրուկտորների և filalizer-ների։ Ածանցյալ դասը օգտագործում է բազային դասի կոդը։ Ածանցյալ դասում հնարավոր է ավելացնել անդամներ։ Ածանցյալ դասը ընդլայնում է բազային դասի ֆունկցիոնալությունը։
...
class Program
{
    static void Main()
    {
        ...
        dog.Eat();        // Output: Dog is eating bones...
        dog.Sleep();      // Output: Sleeping...

        cat.MakeSound();  // Output: Meow
        cat.Eat();        // Output: Eating food... (base implementation is used)
